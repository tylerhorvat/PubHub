		...
		<form action="UpdateBook" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
		      <table>
		         <tr>
		            <td><button type="submit" name="update" class="btn btn-info">Update Book</button></td><td> </td>
		            <td><button type="submit" name="tags" formaction="UpdateTags" formmethod="get" class="btn btn-danger">Edit Tags</button></td>
		         </tr>
